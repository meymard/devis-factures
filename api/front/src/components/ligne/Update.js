...
import { success } from '../../actions/ligne/create';
import { retrieve, update, reset } from '../../actions/ligne/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.ligne.update.retrieveError,
    retrieveLoading: state.ligne.update.retrieveLoading,
    updateError: state.ligne.update.updateError,
    updateLoading: state.ligne.update.updateLoading,
    deleteError: state.ligne.del.error,
    deleteLoading: state.ligne.del.loading,
    created: state.ligne.create.created,
    deleted: state.ligne.del.deleted,
    retrieved: state.ligne.update.retrieved,
    updated: state.ligne.update.updated,
  };
};
