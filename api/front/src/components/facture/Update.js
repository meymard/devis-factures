...
import { success } from '../../actions/facture/create';
import { retrieve, update, reset } from '../../actions/facture/update';
import { del, loading, error } from '../../actions/facture/delete';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.facture.update.retrieveError,
    retrieveLoading: state.facture.update.retrieveLoading,
    updateError: state.facture.update.updateError,
    updateLoading: state.facture.update.updateLoading,
    deleteError: state.facture.del.error,
    deleteLoading: state.facture.del.loading,
    created: state.facture.create.created,
    deleted: state.facture.del.deleted,
    retrieved: state.facture.update.retrieved,
    updated: state.facture.update.updated,
  };
};
