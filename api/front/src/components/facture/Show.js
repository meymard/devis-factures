...
import {retrieve, reset} from '../../actions/facture/show';
...
class Show extends Component {
  ...
  render() {
    ...
    return (<div>
      ...
      {item && <Link to={`/factures/edit/${encodeURIComponent(item['@id'])}`}>
...
const mapStateToProps = (state) => {
  return {
    error: state.facture.show.error,
    loading: state.facture.show.loading,
    retrieved:state.facture.show.retrieved,
