...
import { list, reset } from '../../actions/facture/list';
import { success } from '../../actions/facture/delete';
...
const mapStateToProps = (state) => {
  return {
    data: state.facture.list.data,
    error: state.facture.list.error,
    loading: state.facture.list.loading,
    deletedItem: state.facture.del.deleted,
  };
};
