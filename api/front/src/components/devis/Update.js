...
import { success } from '../../actions/devis/create';
import { retrieve, update, reset } from '../../actions/devis/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.devis.update.retrieveError,
    retrieveLoading: state.devis.update.retrieveLoading,
    updateError: state.devis.update.updateError,
    updateLoading: state.devis.update.updateLoading,
    deleteError: state.devis.del.error,
    deleteLoading: state.devis.del.loading,
    created: state.devis.create.created,
    deleted: state.devis.del.deleted,
    retrieved: state.devis.update.retrieved,
    updated: state.devis.update.updated,
  };
};
