...
import { success } from '../../actions/tva/create';
import { retrieve, update, reset } from '../../actions/tva/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.tva.update.retrieveError,
    retrieveLoading: state.tva.update.retrieveLoading,
    updateError: state.tva.update.updateError,
    updateLoading: state.tva.update.updateLoading,
    deleteError: state.tva.del.error,
    deleteLoading: state.tva.del.loading,
    created: state.tva.create.created,
    deleted: state.tva.del.deleted,
    retrieved: state.tva.update.retrieved,
    updated: state.tva.update.updated,
  };
};
